...
public class consumerTest {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) throws JsonParser.ParseException {
        ...
        DslPart requestResponseBody = new PactDslJsonBody()
                .numberType("id", 1)
                .stringType("firstName", "Sindhuja")
                .stringType("lastName", "Padmanabhan")
                .stringType("email", "spadu@email.com");
